  ...
  <section>
    ...
    <div class="breadcrumb-sec flex-col-center gap-2 py-10 md:py-20">
      ...
      <div class="breadcrumb mt-4">
        <ol class="flex">
          ...
          <li class="text-gray-400"><a href="/blogs" class="flex-row-center hover:text-lightBlue">BLOG <i
                class="bx bxs-chevron-right"></i></a></li>
    ...
    <main class="detail-page">
      <div class="my-12 mx-7">
        <div class="blog flex flex-col md:flex-row md:h-[50vh] lg:h-[90vh] gap-6 md:gap-3">
          <!-- blog img -->
          ...
          <div class="flex flex-col justify-center basis-1/2" data-aos="zoom-in-up" data-aos-delay="200">
            <div class="blog-content pl-0 md:pl-12">
              ...
              <h1 class="text-3xl md:text-4xl lg:md-text-5xl leading-snug my-4 font-extrabold text-darkSteelBlue">
                {{$blog->title}}</h1>
              <div class="w-fit flex items-center justify-between space-x-4">
                ...
                <div class="space-y-2">
                  <p class="text-darkSteelBlue font-semibold"><a
                      href="/blogs/?username={{$blog->author->username}}">Author - {{$blog->author->name}}</a></p>
        ...
        <!-- blog body text -->
        <div
          class="detail-content w-11/12 md:w-10/12 lg:w-7/12 mx-auto my-16 leading-relaxed text-[17px] tracking-wide text-darkSteelBlue">
          ...
          <div class="flex justify-center mt-6">
            <form action="/blogs/{{$blog->slug}}/subscription" method="POST">
              ...
              <button type="submit"
                class="inline-flex items-center my-6 px-5 py-2.5 text-sm font-medium text-center text-darkSteelBlue border-2 border-darkSteelBlue rounded-lg focus:ring-4 focus:ring-gray-200">
                <svg class="w-5 h-5 mr-2 text-darkSteelBlue" fill="currentColor" viewBox="0 0 20 20"
              ...
              @else
              <button type="submit"
                class="inline-flex items-center my-6 px-5 py-2.5 text-sm font-medium text-center text-white bg-darkSteelBlue rounded-lg focus:ring-4 focus:ring-gray-200">
        ...
        <div class="w-7/12 mx-auto my-16">
          ...
          @else
          <p class="text-center">Please <a href="/login" class="text-lightBlue underline">login</a> to participate in
            this discussion.</p>
          @endauth
        </div>
        <!-- comment messages -->
